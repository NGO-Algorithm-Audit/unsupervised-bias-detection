...
The detailed results of our case study and our general approach to bias assessment are visually presented in the attached [slide deck](https://github.com/NGO-Algorithm-Audit/Bias_scan/blob/master/Main_presentation_joint_fairness_assessment_method.pdf). In-depth discussion of the technical details can be found in the technical documentation that is available in our [Github](https://github.com/NGO-Algorithm-Audit/Bias_scan).
